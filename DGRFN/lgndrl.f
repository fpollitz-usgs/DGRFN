...
c	Array dx0 contains (d/d theta) X sub n sup 0 (x=cos(theta)).
	real*8 x,y,fac(25001),tox,bj,bjm,bjp,dang,x0(25001),dx0(25001)
	common/maxl/lmax
	dang=dble(ang)
	x=dcos(dang)
	y=dsin(dang)
...
c	Array dx1 contains (d/d theta) X sub n sup 1 (x=cos(theta)).
	real*8 x,y,fac(25001),tox,bj,bjm,bjp,dang,x1(25001),dx1(25001)
	common/maxl/lmax
	dang=dble(ang)
	x=dcos(dang)
	y=dsin(dang)
...
c	Array dx1 contains (d/d theta) X sub n sup 2 (x=cos(theta)).
	real*8 x,y,fac(25001),tox,bj,bjm,bjp,dang,x2(25001),dx2(25001)
	common/maxl/lmax
	dang=dble(ang)
	x=dcos(dang)
	y=dsin(dang)
